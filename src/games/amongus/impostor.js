  ...
  try {
    const response = await axios.post(
      `${IMPOSTOR_API_URL}/api/lobby/create`,
      {
        ...
        playerSpeedMod: preset.playerSpeed,
        crewLightMod: preset.crewVision,
        impostorLightMod: preset.impVision,
        numCommonTasks: preset.commonTasks,
        numLongTasks: preset.longTasks,
        numShortTasks: preset.shortTasks,
        numEmergencyMeetings: preset.meetings || 1,
        emergencyCooldown: preset.meetingCooldown || 15,
        discussionTime: preset.discussionTime || 15,
        votingTime: preset.votingTime || 120,
        shapeshifterCount: preset.shapeshifters || 0,
        phantomCount: preset.phantoms || 0,
        viperCount: preset.vipers || 0,
        scientistCount: preset.scientists || 0,
        engineerCount: preset.engineers || 0,
        guardianAngelCount: preset.angels || 0,
        noisemakerCount: preset.noisemakers || 0,
        trackerCount: preset.trackers || 0,
        detectiveCount: preset.detectives || 0,
